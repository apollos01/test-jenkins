                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="form-group input-box position-relative">
                                <input 
                                    ...
                                    onChange={handleChange}
                                />
                                <i className="bx bx-buildings position-absolute" style={{ right: '10px', top: '50%', transform: 'translateY(-50%)' }}></i>
                            </div>
                            <div className="form-group input-box position-relative">
                                <input 
                                    type="text" 
                                    ...
                                    onChange={handleChange}
                                />
                                <i className="bx bx-barcode position-absolute" style={{ right: '10px', top: '50%', transform: 'translateY(-50%)' }}></i>
                            </div>
